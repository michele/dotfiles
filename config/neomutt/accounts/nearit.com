...
# Paths ----------------------------------------------
set folder           = ~/.mail/nearit.com               # mailbox location
set alias_file       = ~/.mutt/nearit.com/alias         # where to store aliases
...
# Sync email
macro index O "<shell-escape>offlineimap -a NearIT<enter>"          "run offlineimap to sync all mail"
macro index o "<shell-escape>offlineimap -a NearIT -qf INBOX<enter>" "run offlineimap to sync inbox"
...
set from     = "michele@nearit.com"
set sendmail = "/usr/bin/msmtp -a nearit.com"
set sendmail_wait = 0
